			...
			<div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center ">
				<div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
					...
					<div className="flex justify-center">
						...
						<Link
							href={signUpUrl}
							className="text-white bg-gradient-to-r from-purple-500 via-purple-600 to-purple-700 hover:bg-gradient-to-br focus:ring-4 focus:ring-purple-300 dark:focus:ring-purple-800 font-medium rounded-lg px-7 py-3 text-center mr-2 mb-2 text-[16px] sm:text-xl"
						>
							Get Started
						</Link>
						<button className="ml-4 text-light-heading bg-light-primary border-light-heading border-opacity-60 border-2 py-3 px-8 focus:outline-none  mr-2 mb-2 rounded-md text-[16px] sm:text-xl">
							Learn More
						</button>
					</div>
				</div>
