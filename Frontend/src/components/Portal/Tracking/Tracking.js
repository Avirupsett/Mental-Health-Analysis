    ...
    >
      <main className="min-h-screen bg-gradient-to-b from-slate-50 to-slate-100 py-4 sm:py-6 sm:px-4 md:py-6">
        <div className="px-4 mx-auto max-w-7xl">
          ...
          <StatisticsCards todayDuration={todayDuration} setTodayDuration={setTodayDuration}/>

          <div className="mt-8">
            <EmotionDetection todayDuration={todayDuration} setTodayDuration={setTodayDuration}/>
          </div>
