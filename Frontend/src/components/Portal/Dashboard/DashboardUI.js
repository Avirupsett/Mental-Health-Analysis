...
export default async function DashboardUI() {
  ...
  return (
    <div className="container mx-auto p-4 bg-slate-50">
      ...
      {/* Charts */}
      <Charts formattedStressLevelByDate={dashboardData.formattedStressLevelByDate} formattedEmotionLevelByDate={dashboardData.formattedEmotionLevelByDate} lowStressCount={dashboardData.lowStressCount} moderateStressCount={dashboardData.moderateStressCount} highStressCount={dashboardData.highStressCount} veryHighStressCount={dashboardData.veryHighStressCount} emotionResultsByDate={dashboardData.emotionResultsByDate} emotionCounts={dashboardData.emotionCounts} />
